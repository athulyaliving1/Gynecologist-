  ...
  return (
    <div className="bg-zinc-100">
      <div className="container pb-10 mx-auto">
        ...
        <ul className="grid justify-center gap-3 md:grid-cols-2 lg:grid-cols-3">
          <li className="flex mb-8 space-x-2 font-semibold text-justify text-gray-800 md:text-xl font-Ubuntu ">
            <svg
